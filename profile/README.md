...
## Additionally
* [Leica Camera](https://github.com/Project-SenX/android_vendor_xiaomi_miuicamera) (vendor/xiaomi/miuicamera)
* [Hardware_dolby](https://github.com/Project-SenX/android_hardware_dolby) (hardware/dolby)

## Dolby Atmos
* If you dont want to add Dolby Atmos: In device.mk, set ```TARGET_USES_DOLBY := flase```

## Telegram Device Group:
- [**Group**](https://t.me/senseixhub)
...
## Credit
LineageOS, HdzhungX and All sm8250 dev...
